...
makeLimitedDivSeq (()::qs) (S Z)     = IsFirstLimited01 qs -- 6*<1>+3 = 9
makeLimitedDivSeq (()::qs) (S (S x)) with (mod3 x)
  -- 6 mod 9
  makeLimitedDivSeq (()::qs) (S (S (j + j + j)))         | ThreeZero
    = IsFirstLimited09 qs j $ IsFtoA qs (makeLimitedDivSeq qs) j
  -- 3 mod 9
  makeLimitedDivSeq (()::qs) (S (S (S (j + j + j))))     | ThreeOne with (parity j)
    makeLimitedDivSeq (()::qs) (S (S (S (   (k+k)  +    (k+k)  +    (k+k)))))  | ThreeOne | Even
      = IsFirstLimited11 qs k $ IsFtoA qs (makeLimitedDivSeq qs) k
    makeLimitedDivSeq (()::qs) (S (S (S ((S (k+k)) + (S (k+k)) + (S (k+k)))))) | ThreeOne | Odd  with (mod3 k)
      makeLimitedDivSeq (()::qs) no12_18t06 | ThreeOne | Odd  | ThreeZero
        = IsFirstLimited12 qs l $ IsFtoA qs (makeLimitedDivSeq qs) (l+l)
      makeLimitedDivSeq (()::qs) no13_18t12 | ThreeOne | Odd  | ThreeOne
        = IsFirstLimited13 qs l $ IsFtoA qs (makeLimitedDivSeq qs) (S ((l+l)+(l+l)))
      makeLimitedDivSeq (()::qs) no14_18t18 | ThreeOne | Odd  | ThreeTwo
        = IsFirstLimited14 qs l $ IsFtoA qs (makeLimitedDivSeq qs) (S (S (S (S (S (S (S (l+l+l+l)+(l+l+l+l))))))))
  -- 0 mod 9
  makeLimitedDivSeq (()::qs) (S (S (S (S (j + j + j))))) | ThreeTwo with (parity j)
    makeLimitedDivSeq (()::qs) (S (S (S (S ((k+k) + (k+k) + (k+k)))))) | ThreeTwo | Even with (mod3 k)
      makeLimitedDivSeq (()::qs) no06_18t04 | ThreeTwo | Even | ThreeZero
        = IsFirstLimited06 qs l $ IsFtoA qs (makeLimitedDivSeq qs) (S (S (S (l+l+l+l)+(l+l+l+l)+(l+l+l+l)+(l+l+l+l))))
      makeLimitedDivSeq (()::qs) no07_18t10 | ThreeTwo | Even | ThreeOne
        = IsFirstLimited07 qs l $ IsFtoA qs (makeLimitedDivSeq qs) (S (S (S (S (l+l+l+l)+(l+l+l+l)))))
      makeLimitedDivSeq (()::qs) no08_18t16 | ThreeTwo | Even | ThreeTwo
        = IsFirstLimited08 qs l $ IsFtoA qs (makeLimitedDivSeq qs) (S (S (S ((l+l)+(l+l)))))
    makeLimitedDivSeq (()::qs) (S (S (S (S (S (k+k) + S (k+k) + S (k+k)))))) | ThreeTwo | Odd with (parity k)
      makeLimitedDivSeq (()::qs) no02_12t07 | ThreeTwo | Odd | Even
        = IsFirstLimited02 qs l $ IsFtoA qs (makeLimitedDivSeq qs) l
      makeLimitedDivSeq (()::qs) noxx_12t13 | ThreeTwo | Odd | Odd  with (mod3 l)
        makeLimitedDivSeq (()::qs) no03_36t13 | ThreeTwo | Odd | Odd | ThreeZero
          = IsFirstLimited03 qs m $ IsFtoA qs (makeLimitedDivSeq qs) (m+m)
        makeLimitedDivSeq (()::qs) no04_36t25 | ThreeTwo | Odd | Odd | ThreeOne
          = IsFirstLimited04 qs m $ IsFtoA qs (makeLimitedDivSeq qs) (S ((m+m)+(m+m)))
        makeLimitedDivSeq (()::qs) no05_36t37 | ThreeTwo | Odd | Odd | ThreeTwo
