...
export
lte108t99_2 : (l : Nat) -> LTE (S (S (S (S ((l+l)+(l+l))))))
  (S (S (S (S ((S (S (l+l+l))+S (S (l+l+l))) + (S (S (l+l+l))+S (S (l+l+l))) + (S (S (l+l+l))+S (S (l+l+l))))))))
lte108t99_2 Z     = (lteSuccRight . lteSuccRight . lteSuccRight . lteSuccRight . lteSuccRight . lteSuccRight . lteSuccRight . lteSuccRight . lteSuccRight . lteSuccRight . lteSuccRight . lteSuccRight . LTESucc . LTESucc . LTESucc . LTESucc) LTEZero
lte108t99_2 (S l) =
  let lemma = lte108t99_2 l in
  ...
  rewrite (sym (plusSuccRightSucc (plus (plus (plus l l) l) (S (S (plus (plus l l) l))))
                                            ...
                                            l))))))))) in
  rewrite (sym (plusSuccRightSucc (plus (plus (plus l l) l) (S (S (plus (plus l l) l))))
                                                  (S (S (plus (plus (plus l l) l) (S (S (plus (plus l l)
                                            l)))))))) in

  rewrite (sym (plusSuccRightSucc (plus (plus (plus (plus l l) l) (S (S (plus (plus l l) l))))
                        (S (S (plus (plus (plus l l) l) (S (S (plus (plus l l) l)))))))
                                  (S (S (S (S (S (S (S (plus (plus (plus l l) l)
                        (S (S (plus (plus l l) l))))))))))))) in
  rewrite (sym (plusSuccRightSucc (plus (plus (plus (plus l l) l) (S (S (plus (plus l l) l))))
                        (S (S (plus (plus (plus l l) l) (S (S (plus (plus l l) l)))))))
