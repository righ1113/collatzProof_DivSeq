...
export
lte108t27_2 : (l : Nat) -> LTE (S (S (S (S (l+l+l+l)+(l+l+l+l)+(l+l+l+l)+(l+l+l+l)))))
  ((S (S (S (S (((l+l+l)+(l+l+l)) + ((l+l+l)+(l+l+l)) + ((l+l+l)+(l+l+l))))))))
lte108t27_2 Z     = (LTESucc . LTESucc . LTESucc . LTESucc) LTEZero
lte108t27_2 (S l) =
  let lemma = lte108t27_2 l in
  ...
  rewrite (sym (plusSuccRightSucc (plus (plus (plus l l) l) (plus (plus l l) l))
                                              (S (plus (plus (plus l l) l) (plus (plus l l) l))))) in
  rewrite (sym (plusSuccRightSucc (plus (plus (plus l l) l) (plus (plus l l) l))
                                                  (plus (plus (plus l l) l) (plus (plus l l) l)))) in

  rewrite (sym (plusSuccRightSucc (plus (plus (plus (plus l l) l) (plus (plus l l) l))
                                      (plus (plus (plus l l) l) (plus (plus l l) l)))
                                  (S (S (S (S (S (plus (plus (plus l l) l) (plus (plus l l)
                                              l))))))))) in
  rewrite (sym (plusSuccRightSucc (plus (plus (plus (plus l l) l) (plus (plus l l) l))
                                      (plus (plus (plus l l) l) (plus (plus l l) l)))
  ...
  rewrite (sym (plusSuccRightSucc (plus (plus (plus (plus l l) l) (plus (plus l l) l))
                                      (plus (plus (plus l l) l) (plus (plus l l) l)))
                                                  (plus (plus (plus l l) l) (plus (plus l l)
                                              l)))) in
